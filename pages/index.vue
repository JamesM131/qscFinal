  ...
  <div class="tw-overflow-hidden">
    ...
    <div class="tw-flex tw-justify-center">
      <div class="tw-w-9/12 tw-pb-0 tw-mt-4 tw-mb-4">
        <div
          class="tw-px-10 tw-flex tw-flex-col tw-justify-center tw-items-center tw-py-4 tw-mt-2 tw-bg-gray-100 tw-rounded tw-shadow min_height"
        >
          <h1 class="tw-mb-3 tw-text-2xl tw-font-extrabold text-center">
            Welcome
          </h1>
          <!-- eslint-disable  -->
          <div class="tw-text-gray-800 tw-self-center" v-html="home"></div>
          <!-- eslint-enable -->
        </div>
      </div>
    </div>
