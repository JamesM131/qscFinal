<template>
  <div class="tw-relative tw-h-full my-wrapper">
    ...
    <div
      style="height: 100%"
      class="tw-flex tw-flex-wrap tw-px-2 tw-py-10 tw-mt-3 lg:tw-mt-0 lg:tw-pr-10"
    >
      <div
      ...
      <div
        class="tw-w-full tw-h-full tw-ml-5 lg:tw-w-5/12 lg:tw-h-auto bounded-container lg:tw-overflow-y-auto"
      >
        <h1 class="white--text">{{ name }}</h1>
        <div
          class="tw-block tw-w-full lg:tw-w-2/12 px-0 lg:tw-mt-5 lg:tw-ml-5 text-xs-center lg:tw-hidden"
        >
          <div
      ...
      <div
        class="tw-hidden tw-w-full px-0 lg:tw-w-2/12 lg:tw-mt-5 lg:tw-ml-5 text-xs-center lg:tw-block"
      >
        <div
          class="tw-flex tw-justify-center lg:tw-justify-start contact_details"
        >
